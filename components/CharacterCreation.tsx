        ...
        return (
            <div className="fixed inset-0 z-50 bg-slate-950 flex flex-col items-center justify-center font-sans overflow-hidden" role="main" aria-label="Title Screen">
                ...
                <div className="z-10 flex flex-col gap-4 w-full max-w-xs animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-300">
                    ...
                    {/* ADMIN TOOLS */}
                    {userSession && (
                        <div className="z-10 mt-2 animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-500">
                            <button
                                onClick={() => useContentStore.getState().publishContentToCloud()}
                                className="w-full group relative bg-slate-900/80 border border-red-500/30 hover:border-red-500 text-red-100 py-3 px-6 rounded-lg transition-all transform hover:scale-105 overflow-hidden shadow-lg focus:ring-2 focus:ring-red-500 outline-none"
                            >
                                <span className="relative font-bold uppercase tracking-widest text-[10px] flex items-center justify-center gap-2">
                                    ⚡ ADMIN: PUBLISH DATA
                                </span>
                            </button>
                        </div>
