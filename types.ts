...
export interface Spell { id: string; name: string; level: number; range: number; type: SpellType; damageType?: DamageType; diceCount: number; diceSides: number; aoeRadius?: number; aoeType?: 'CIRCLE'|'CONE'|'LINE'; description: string; animation: string; icon: string; }
export interface Skill { id: string; name: string; description: string; staminaCost: number; cooldown: number; range: number; damageMultiplier: number; damageType?: DamageType; diceCount?: number; diceSides?: number; effect: string; statusEffect?: string; isBonusAction?: boolean; aoeRadius?: number; aoeType?: 'CIRCLE'|'CONE'; animation?: string; icon: string; }
